				...
				<div class="col-xs-12 col-sm-12">
					...
					<ul id="lightSlider">
						<li class="featurePane col-xs-4">
							<a href="news/#trustees" title="view the latest newsletter">
								<img src="/assets/images/WVI-TrusteesNewsPost-868×414-2.jpg" class="img-responsive" alt="welcoming expressions of interest to become a WVI charity trustee"/></a>
